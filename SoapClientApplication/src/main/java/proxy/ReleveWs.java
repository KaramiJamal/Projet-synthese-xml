 ...
 * 
 */
@WebServiceClient(name = "releve-ws", targetNamespace = "http://controllers/", wsdlLocation = "http://localhost:8080/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RELEVEWS_QNAME = new QName("http://controllers/", "releve-ws");
     ...
     * 
     * @return
     *     returns ReleveController
     */
    @WebEndpoint(name = "ReleveControllerPort")
    public ReleveController getReleveControllerPort() {
        return super.getPort(new QName("http://controllers/", "ReleveControllerPort"), ReleveController.class);
    }
     ...
     */
    @WebEndpoint(name = "ReleveControllerPort")
    public ReleveController getReleveControllerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controllers/", "ReleveControllerPort"), ReleveController.class, features);
    }
